...
- POST-запрос для вычесления дистанция меджу аэропортами
- POST-запрос на добавление аэропорта в избранное
- POST-запрос на удаление аэропорта в избранное
- POST-запрос на удаление все элементов в избранном
- PATCH-запрос на редактирование данные для ажропорта в избранном
...
- После каждого прогона тестов бот отправляет:
  - Текстовую сводку с количеством успешных/упавших/пропущенных тестов
